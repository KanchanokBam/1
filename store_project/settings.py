...
SECRET_KEY = "django-insecure-ruco%i6diro-@zf^76$gx0s1&2fi@-trlz-@^!)-a8apl4_qwm"
...
LOGIN_URL = '/login/'  
LOGIN_REDIRECT_URL = '/home'  # ✅ เมื่อ Login สำเร็จให้ไปที่ไหน
LOGOUT_REDIRECT_URL = '/login'  # ✅ เมื่อ Logout ให้ไปที่หน้าแรก
